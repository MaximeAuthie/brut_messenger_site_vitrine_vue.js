            ...
            <div class="legal-text">
                ...
                <p>
                    ...
                    <ul>
                        ...
                        <li>Messages et conversation.</li>
                    </ul>
                </p>
                <p>
                    La collecte et le traitement de ces données répond à aux finalités suivantes :
                    <ul>
                        <li>Personnaliser l’utilisation de notre service.</li>
                        <li>Communiquer avec vous en cas de besoin.</li>
                    </ul>
                </p>
                ...
                <p> Lorsque vous utilisez notre site, sont automatiquement collectées les données suivantes :
                    <ul>
                        <li>Aucune donnée collectée sans utilisation de la page « Inscription » ou « Connexion ».</li>
                    </ul>
                </p>
                <p>
                ...
                <p>
                    Elles sont conservées par le responsable du traitement dans des conditions raisonnables de sécurité, pour une durée de 12 mois. 
                ...
                <p>
                    Les données à caractère personnelles sont collectées par BRUT MESSENGER, SAS au capital de 100 000€, dont le numéro d’immatriculation est le XXXXXXXXXXXXX.  
                ...
                <p>
                    L’éditeur du site, BRUT MESSENGER, se réserve le droit de pouvoir modifier la présente Politique à tout moment afin d’assurer aux utilisateurs du site sa conformité avec le droit en vigueur.<br>
                    ...
                    <br>
                    La présente politique, éditée le 17/02/2023, a été mise à jour le 17/02/2023.
                </p>
            </div>
        </div>
    </div>
