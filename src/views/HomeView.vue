<template>
     <div id="content-body-home">
        <section id="first-section">
            <h2>un design unique</h2>
            <p class="section-text-center">
                Fini le design sobre et ennuyeux des applications de messagerie!<br>
                <span>BRUT MESSENGER</span> s’inspire du mouvement Néobrutaliste pour vous proposer une toute nouvelle expérience visuelle.
            </p>
        </section>
        <div id="phone-div">
        ...
        <section id="third-section">
            <h2>ultra sécurisé</h2>
            <p class="section-text-center">
                Avec <span>BRUT MESSENGER</span> vous êtes entre de bonnes mains !
            </p>
            <div class="div-img-text">
                <p class="div-text-left">
